...
public class RedisService {
     ...
     * @return
     */
    public double hashDecrment(String key, String item, double by) {
        return redisTemplate.opsForHash().increment(key, item, -by);
    }
     ...
     * @return 成功个数
     */
    public long addMembers(String key, Object... values) {
     ...
     * @return 成功个数
     */
    public long addMembersAndTime(String key, long time, Object... values) {
     ...
     * @return
     */
    public boolean addListAndTime(String key, Object value, long time) {
        redisTemplate.opsForList().rightPush(key, value);
        if (time > 0) {
            expire(key, time);
        }
     ...
     * @return
     */
    public boolean setValueByIndex(String key, long index, Object value) {
